...
4. Understand the [basic data types](#data_types) (integer, double, character, factor)
...
1. Appropriately [structure an R script](#structure)
2. Create a simple [data table](#data_table)
3. [Load data](#load_data) from a CSV and Excel files
4. Create and compile an [Rmarkdown document](#rmarkdown)
