...
Create subsets of the data. At first, you'll just use this to create summaries, 
like the mean value for al of your experimental groups.
...
3. Select all of the columns with Extraversion questions.
    ...
    # this is the quickest way in this dataset
...
factors. Count how many of the questions in each domain were not answered and 
