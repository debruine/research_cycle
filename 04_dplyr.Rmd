...
2. Be able to use `lubridate` for simple [date calculations](#dates)
...
factors. Count how many of the questions in each domain were answered by each 
user and filter to only people who answered at least 5 questions in each domain.
...
5. Create a violin plot of mean score distribution for each the 5 personality 
factors from the full dataset.
